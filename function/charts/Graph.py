...
class Graph:
    ...
    def help(self):
        ...
        ii = {'name -> str': '图例名称',
              ...
              'is_rotatelabel -> bool': '是否旋转标签，默认为False',
              'graph_layout -> str': '关系图布局，默认为"force"' +
              ...
              'graph_edge_symbolsize -> int/list': '边两端的标记大小，可以是一个数组分别指定两端，也可以是单个统一指定。',
              'Note': '可配置lineStyle参数'}
